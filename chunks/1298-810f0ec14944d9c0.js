        ...
        31298: function(t, e, n) {
            ...
            function h(t) {
                ...
                var o = n.match(/(.*?)([0-9]+)(.*)/),
                    ...
                    i = o ? o[3] : "",
                    a = o ? o[2] : n,
                    s = a.length >= e ? a : (m(Array(e)).map((function() {
                        return "0"
                    })).join("") + a).slice(-1 * e);
            ...
            function v(t, e) {
                var n = t.days,
                    ...
                    r = t.minutes,
                    i = t.seconds,
                    a = Object.assign(Object.assign({}, y), e),
                    s = a.daysInHours,
                    c = a.zeroPadTime,
                    u = a.zeroPadDays,
                    l = void 0 === u ? c : u,
                    p = Math.min(2, c),
                    f = s ? h(o + 24 * n, c) : h(o, p);
                return {
                    days: s ? "" : h(n, l),
                    hours: f,
                    minutes: h(r, p),
            ...
            var T = function(t) {
                ...
                function n() {
                    var t;
                    return i(this, n), (t = e.apply(this, arguments)).state = {
                ...
                return s(n, [{
                    ...
                    key: "render",
                    value: function() {
                        return this.props.children ? (0, o.cloneElement)(this.props.children, {
            ...
            var S = function(t) {
                ...
                function n(t) {
                    var r;
                    if (i(this, n), (r = e.call(this, t)).mounted = !1, r.initialTimestamp = r.calcOffsetStartTimestamp(), r.offsetStartTimestamp = r.props.autoStart ? 0 : r.initialTimestamp, r.offsetTime = 0, r.legacyMode = !1, r.legacyCountdownRef = (0, o.createRef)(), r.tick = function() {
                        ...
                        }, r.handleOnComplete = function(t) {
                            r.props.onComplete && r.props.onComplete(t)
                        }, t.date) {
                ...
                return s(n, [{
                    ...
                    value: function(t, e, n) {
                        ...
                        if (this.mounted) {
                            var r;
                            !this.state.timeDelta.completed && t.completed && (this.props.overtime || this.clearTimer(), r = this.handleOnComplete);
                            return this.setState((function(n) {
                                var r = e || n.status;
                                return t.completed && !o.props.overtime ? r = "COMPLETED" : e || "COMPLETED" !== r || (r = "STOPPED"), {
                                    timeDelta: t,
                                    status: r
                                }
                            }), (function() {
                                n && n(o.state.timeDelta), r && r(o.state.timeDelta)
                            }))
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        if (u) return u(l);
                        if (c && this.state.timeDelta.completed && !s) return (0, o.cloneElement)(c, {
                            countdown: l
                        });
                        var p = l.formatted,
                            f = p.days,
            ...
            S.defaultProps = Object.assign(Object.assign({}, y), {
                controlled: !1,
                intervalDelay: 1e3,
                precision: 0,
                autoStart: !0
